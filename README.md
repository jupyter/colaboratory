...
*CoLaboratory is no longer being actively developed or maintained.  We will consider minor pull requests, but most of the CoLaboratory team's focus is now on integration of Google Drive with IPython/Jupyter.  For more information on this project see https://github.com/jupyter/jupyter-drive*
