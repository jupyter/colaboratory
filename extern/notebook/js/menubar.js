...
var IPython = (function (IPython) {
    ...
    MenuBar.prototype.style = function () {
        ...
        this.element.find("li").click(function (event, ui) {
                // if url is empty don't act on it.
    ...
    MenuBar.prototype.bind_events = function () {
        ...
        this.element.find('#copy_notebook').click(function() {
          IPython.DriveUtil.copyNotebook(function(resp) {
            window.location = '/googledrive/create#notebook_id=' + resp.id;
            window.location.reload();
          }, function(resp) {
            console.log(resp);
            alert('Unable to copy. See console for details');
          });
