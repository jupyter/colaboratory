...
var IPython = (function (IPython) {
    ...
    OutputArea.prototype.append_mime_type = function (json, element, dynamic) {
        for(var type_i in OutputArea.display_order){
            ...
            if(json[type] != undefined ){
                ...
                if(type == 'javascript'){
                    ...
                    if (md && md.ephemeral) return false
                } else {
        ...
        // It is not clear that we should be adding an empty
        // div if we didn't add the content to the element.
        // but we keep it here in the interest of backward compatibility
        return true
    };
    ...
    OutputArea.prototype.append_javascript = function (js, md, container) {
        if (!md || !md.ephemeral) {
          // Add a container element unless javascript is ephemeral, in which
          // case no need to add a subarea.
