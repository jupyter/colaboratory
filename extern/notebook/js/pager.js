...
var IPython = (function (IPython) {
    ...
    Pager.prototype.style = function () {
        ...
        this.pager_element.find("#pager-container").addClass('border-box-sizing');
    ...
    Pager.prototype.clear = function (text) {
        this.pager_element.find("#pager-container").empty();
    };
    ...
    Pager.prototype.append_text = function (text) {
        this.pager_element.find("#pager-container").append($('<pre/>').html(utils.fixCarriageReturn(utils.fixConsole(text))));
    };
