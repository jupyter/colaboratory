...
function (marked) {
    ...
    // TODO(madadam): Clean up this style tweaking.
    // $('#ipython-main-app').addClass('border-box-sizing');
    $('div#notebook_panel').addClass('border-box-sizing');

    var baseProjectUrl = $('body').data('baseProjectUrl');
    var enableComments = ($('body').data('enableComments') == "True");
    ...
    // GOOGLE_EDIT
    // choose notebook class based on whether drive notebook is detected.
    var notebook_id = $('body').data('notebookId');
    if(typeof IPython.DriveNotebook !== 'undefined' &&
        notebook_id.indexOf(IPython.DriveNotebook.prototype.GOOGLE_DRIVE_SENTINEL) == 0) {
        IPython.notebook = new IPython.DriveNotebook('div#notebook',{baseProjectUrl:baseProjectUrl});
    } else {
