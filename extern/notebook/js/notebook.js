...
var IPython = (function (IPython) {
    ...
    Notebook.prototype.create_elements = function () {
        ...
        var that = this;
        // TODO(madadam): condition on enable_comments?
    ...
    Notebook.prototype.insert_cell_at_index = function(type, index){
        ...
        if (ncells === 0 || this.is_valid_cell_index(index) || index === ncells) {
            ...
            // TODO(madadam): The Cell constructor should be a better place to
            // call this, but then it gets called spuriously (when a real cell
            // is not actually being created).  Track down why.
            cell.add_comment_widget();
    ...
    Notebook.prototype.copy_cell = function () {
        ...
        if (this.clipboard.metadata.cell_id != undefined) {
            delete this.clipboard.metadata.cell_id;
        }
        this.enable_paste();
    };
    ...
    Notebook.prototype.start_kernel = function () {
        url = $.cookie("kernel_url");
        if (url != undefined) {
          $('body').data('baseKernelUrl', url);
        }
    ...
    Notebook.prototype.load_notebook_success = function (data, status, xhr) {
        ...
        // GOOGLE_EDIT
        if (typeof IPython.Fbase !== 'undefined') {
            IPython.firebase.loadFirebase();
        }
    ...
    Notebook.prototype.show_sidebar_panel = function(){
        $('#sidebar_panel').show();
        $('#notebook_panel').removeClass("span12").addClass("span10");
    }

    Notebook.prototype.hide_sidebar_panel = function(){
        $('#sidebar_panel').hide();
        $('#notebook_panel').removeClass("span10").addClass("span12");
    }
