...
var IPython = (function (IPython) {
    ...
    Cell.prototype.add_comment_widget = function() {
        var enableComments = ($('body').data('enableComments') == "True");
        if (enableComments) {
          this.comment_widget =
              new IPython.CommentWidget(this, 'div#comment_widget_container');
        }
    }
    ...
    Cell.prototype.select = function () {
        ...
        this.selected = true;
        if (this.hasOwnProperty('comment_widget')) {
          this.comment_widget.set_selected(true);
        }
    };
    ...
    Cell.prototype.unselect = function () {
        ...
        this.selected = false;
        if (this.hasOwnProperty('comment_widget')) {
          this.comment_widget.set_selected(false);
        }
    };
